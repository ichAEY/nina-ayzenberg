...
export default {
  ...
  master: {
    ...
    aboutLead: "Я Нина — мастер маникюра и педикюра с опытом более двух лет.",
    aboutParagraphs: [
      "Я работаю с женским и мужским маникюром и педикюром, наращиванием и дизайном ногтей. Также выполняю медицинский маникюр и педикюр.",
      "Принимаю по предварительной записи в частном кабинете в Хорошёво‑Мнёвниках. Здесь можно посмотреть мои работы, актуальные услуги и цены и выбрать удобный способ связи.",
    ],
  ...
  // Real reviews from Nina's public Yandex Maps card. Do not paraphrase or invent reviews.
  reviews: [
    { text: "Долго искала хорошего мастера и наконец-то нашла. Быстро, качественно и в приятной обстановке.", author: "Диана Дерунец" },
    { text: "Таких мастеров не сыщешь. Все аккуратно, покрытие держится весь срок, любой дизайн и идеи воплотятся в жизнь. Спасибо большое ❤️❤️❤️", author: "Екатерина П." },
    { text: "Чистое, уютное место. Мастер аккуратная и внимательная. Все отлично, мне понравилось, буду ходить еще ! Рекомендую!!", author: "Евгения Мельникова" },
  ],
